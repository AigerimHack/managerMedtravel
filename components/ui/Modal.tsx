  ...
  return (
    ...
    >
      <div style={{ background: '#fff', borderRadius: 20, width: '100%', maxWidth: wide ? 680 : 500, maxHeight: '88vh', display: 'flex', flexDirection: 'column', boxShadow: '0 24px 64px rgba(0,0,0,0.18)' }}>
        <div className="modal-head" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '20px 28px 18px', borderBottom: '1.5px solid #f1f5f9', flexShrink: 0 }}>
        ...
        {footer && (
          <div className="modal-foot" style={{ padding: '16px 28px 20px', borderTop: '1.5px solid #f1f5f9', display: 'flex', alignItems: 'center', justifyContent: 'flex-end', gap: 10, flexShrink: 0, background: '#fff', borderRadius: '0 0 20px 20px' }}>
            {footer}
          </div>
        )}
      </div>
